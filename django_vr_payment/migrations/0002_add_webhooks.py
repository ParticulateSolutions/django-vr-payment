    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raw_headers', BaseJSONField(help_text='response header as json', verbose_name='Headers')),
                ...
                ('decrypted_body', BaseJSONField(help_text='The decrypted request.body in JSON', verbose_name='Decrypted body')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raw_headers', BaseJSONField(help_text='response header as json', verbose_name='Headers')),
                ('raw_content', BaseJSONField(help_text='response content as json', verbose_name='Content')),
                ...
                ('result_details', BaseJSONField(blank=True, help_text='A container for name value pair used for enriching the response with bank-specific response details. I.e. the actual parameters used within resultDetails are bank-specific.', null=True, verbose_name='Result details')),
                ('result_details_acquirer_response', BaseJSONField(blank=True, help_text='Represents the acquirer original response code retrieved from the acquirer directly.', null=True, verbose_name='Result details - Acquirer response')),
                ...
                ('other', BaseJSONField(blank=True, help_text="The response can also contain each of the data structures listed above, such as 'customer' and 'billingAddress'.", null=True, verbose_name='Other')),
            ],
            options={
